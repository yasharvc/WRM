...
namespace Contracts
{
	public class TypeConverter
	{
		...
		public T Convert<T>(object input) {return (T)Convert(input, typeof(T));}
		...
		public bool IsGeneric(Type type) {return type.IsGenericType;}
		...
		public bool IsDictionary(Type type) {return IsGeneric(type) && (
